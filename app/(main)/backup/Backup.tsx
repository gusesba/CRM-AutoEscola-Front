...
export default function Backup() {
  ...
  useEffect(() => {
    ...
    setChats([]);
    getBackupConversations(activeUserId)
      .then(setChats)
      .catch(console.error)
      ...
      <div className="mx-auto max-w-[1400px] mt-[-30px]">
        <div className="flex flex-wrap items-center gap-3 px-2 py-3">
          ...
          <button
            type="button"
            disabled
            title="Envio em grupo indisponível no backup."
          ...
          <button
            type="button"
            disabled
            title="Sessão não aplicável ao backup."
        ...
        >
          ...
          <ChatWindow
            ...
            fetchMessagesFn={(_userId, chatId, limit) =>
